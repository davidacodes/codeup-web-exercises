...
var amountTip = calculateTip(billAmount, tipPercent);
alert("Please tip this amount " + amountTip + " monies.");
 ...
 */
function applyDiscount(itemPrice, amountDiscount) {
    return (itemPrice - (amountDiscount * itemPrice));
}